...
public class TestSalon {
    ...
    public static void mostrarMenu() {
        ...
        System.out.println("[7] muestra los salones con mayor capacidad.");//falta hacer
    ...
    public static void mostrarDatosDeSalones(Salon[] arregloSalon) {
        ...
        System.out.println("longitud arreglo: " +arregloSalon.length);
        for (int i = 0; i < 2; i++) {
            System.out.println(arregloSalon[i].toString());
